...
const Generate = () => {
  return (
    ...
    {/* image section */}
      <div className='bg-neutral-700 w-50 h-50'>
      </div>
      ...
      {/* prompt box */} 
        <textarea name="" id="" className='bg-neutral-900 text-white w-130 h-40 border-3 border-black rounded-xl p-2 text-xl overflow-hidden opacity-75 focus:outline-none'></textarea>
      {/* generate button  */}
      <button type='submit' className='bg-neutral-900 text-neutral-200 px-10 py-4 w-fit rounded-full border-3 border-black cursor-pointer hover:border-neutral-200 transition-all duration-500'>
        GENERATE 
      </button>
      </form>
    </div>
