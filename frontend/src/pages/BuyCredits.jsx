...
const BuyCredits = () => {
  ...
  return (
    <div className='flex flex-col items-center'>
      <div className='flex justify-center text-neutral-200 mt-[4vw] text-[3vw] font-bold'>
        <p>BUY CREDITS</p>
      </div>
      <p className='text-neutral-200'>(1 CREDIT: ₹10)</p>
      <form className='flex flex-col items-center gap-[6vw] text-neutral-200 mt-[5vw]'>
        ...
        <button type='button' className='bg-blue-400 rounded-md w-[11vw] h-[4vw] text-[1.6vw] text-white cursor-pointer'>
          <p>Buy Now</p>
        </button>
        </div>
      </form>
