...
const Profile = () => {
  ...
  const { user, credits, backendUrl, setUser, setCredits } = useContext(AppContext);
      ...
      <div className='w-full flex justify-around items-start mt-[3vw]'>
          ...
          <div className='flex flex-col items-start gap-[1.2vw] mt-[3vw]'>
            ...
            <div className='flex flex-col'>
              ...
              <div className='flex flex-col items-start gap-[0.5vw] border-1 border-red-400 p-[0.7vw] rounded-md'>
                ...
                <button className='bg-red-600 text-neutral-200 text-[1.3vw] font-semibold p-[0.5vw] rounded-md cursor-pointer border-2 border-red-600 hover:border-black hover:text-black transition-all duration-500'>
                  DELETE ACCOUNT
                </button>
              </div>
            </div>
        ...
        <div className='flex flex-col justify-center gap-[1.5vw] mt-[5vw]'>
          ...
          <div className='flex items-center gap-[1vw] text-[1.45vw] bg-neutral-700 px-[1.1vw] p-[1vw] rounded-md'>
            <p>Edit Name </p>
            <input type="text" className='bg-neutral-900 px-[1vw] py-[0.9vh] outline-none border-2 border-neutral-900 focus:border-neutral-500 transition-all duration-500 rounded-md' placeholder='Enter new username' />
            <button className='bg-yellow-600 px-[1vw] py-[0.5vw] rounded-md font-medium cursor-pointer hover:bg-yellow-500 transition-all duration-300'>
              CONFIRM
            </button>
          </div>
          {/* change password */}
          {
            changePwd
              ...
              <div className='relative flex flex-col items-center bg-neutral-700 p-[1vw] gap-[1vw] rounded-md'>
                ...
                <p>Change Password</p>
                <input type="password" className='bg-neutral-900 w-[21vw] px-[1.5vw] py-[0.7vw] text-[1.4vw] outline-none border-2 border-neutral-900 focus:border-neutral-500 transition-all duration-500 rounded-md' placeholder='Enter Old Password' />
                <input type="password" className='bg-neutral-900 w-[21vw] px-[1.5vw] py-[0.7vw] text-[1.4vw] outline-none border-2 border-neutral-900 focus:border-neutral-500 transition-all duration-500 rounded-md' placeholder='Enter New Password' />
                <button className='bg-yellow-600 px-[1vw] py-[0.5vw] rounded-md font-medium cursor-pointer hover:bg-yellow-500 transition-all duration-300'>
                  CONFIRM
                </button>
              </div>
