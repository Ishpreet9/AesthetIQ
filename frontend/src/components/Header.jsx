...
const Header = () => {
  ...
  return (
    <div className='flex flex-col justify-center items-center text-center md:my-[9vh] my-12'>
      ...
      <h1 className='md:text-[4vw] text-4xl md:max-w-[50vw] max-w-[360px] mx-auto md:mt-10 mt-8 text-center font-bold text-neutral-300'>"Your Imagination, Rendered in Pixels by AI"</h1>
      <Link to={user ? '/generate' : '/login'}>
      <button className='md:mt-[4vw] mt-14 bg-neutral-200 md:px-[1.2vw] px-3 md:py-[1.2vh] py-1 font-bold md:text-[1.7vw] text-xl rounded-full inline-flex items-center gap-3 cursor-pointer border-3 border-black hover:bg-yellow-200/5 hover:text-neutral-200 hover:border-yellow-300/90 transition-all duration-400'>Generate Images
