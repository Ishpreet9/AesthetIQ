...
const Header = () => {
  return (
    <div className='flex flex-col justify-center items-center text-center md:my-18 my-12'>
      ...
      <h1 style={{ WebkitTextStroke: "1px black" }} className='md:text-6xl text-4xl sm:max-w-[750px] max-w-[360px] mx-auto md:mt-10 mt-8 text-center font-bold text-neutral-300'>"Your Imagination, Rendered in Pixels by AI"</h1>
      <Link to={'/generate'}>
